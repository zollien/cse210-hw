...
class Program
{
    static void Main(string[] args)
    {
        ...
        //loop
        while (number != 0)
        // this loop will evaluate teh inputted number adn if it can continue it will or it will stop because the condition in not met to continue
        {
            ...
            if (number != 0)
            {
                //what will be added to the list - add number to numbers list
                numbers.Add(number);
            }
        }
